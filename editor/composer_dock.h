#ifndef COMPOSER_DOCK_H
#define COMPOSER_DOCK_H
...
class ComposerDock : public VBoxContainer {
    GDCLASS(ComposerDock, VBoxContainer);

private:
    RichTextLabel *composer_display = nullptr;
